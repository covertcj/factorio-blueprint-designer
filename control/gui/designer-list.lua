...
function generate_designer_table(parent)
    ...
    if next(global.designers) == nil then
        ...
        for _, designer in pairs(global.designers) do
            ...
            designer_table.add({type = 'sprite-button', name = 'blueprint-designer-list-enter-' .. designer.name, sprite='bpd-enter-icon-small', style='bpd-small-sprite-button'})
            designer_table.add({type = 'sprite-button', name = 'blueprint-designer-list-delete-' .. designer.name, sprite='bpd-delete-icon-small', style='bpd-small-sprite-button'})
        end
    end
end
